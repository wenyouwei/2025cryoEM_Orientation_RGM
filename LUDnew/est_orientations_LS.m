function [est_inv_rots, Gram] = est_orientations_LS(common_lines_matrix, L, pars,ref_rot)
...
% Using the rounding procedure to recover the rotations from the Gram matrix.
fprintf('Startig the rounding procedure');fprintf('Startig the rounding procedure\n');
